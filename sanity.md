...
I'll do the ame for all other types also. Like fetchSocials.ts, fetchProjects.ts, fetchPageInfo.ts, fetchExperience.ts

## Incremenetal static regeneration

I go back to index.tsx and add the following code to it =>
